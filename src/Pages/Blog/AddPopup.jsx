    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-gray-50 rounded-2xl w-[43%]  max-h-[95vh] overflow-y-auto shadow-2xl transform transition-all">
        ...
        <div className="flex items-center justify-between p-6 border-b bg-gradient-to-r">
          <h2 className="text-2xl font-bold text-black">Add Block Form</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-1">
            <label htmlFor="title" className="block text-base	 font-semibold text-gray-500">
              Blog Title
            </label>
            <input
              id="title"
          ...
          {/* Description Input */}
          <div className="space-y-1">
            <label htmlFor="description" className="block text-base font-semibold text-gray-500">
              Description
            </label>
            <textarea
              id="description"
              ...
              <label className="w-full flex flex-col items-center px-6 py-8 bg-gray-50 rounded-xl border-2 border-dashed border-yellow-300 cursor-pointer hover:bg-gray-100 transition-colors">
                {imagePreview ? (
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center">
                      <span className="text-sm text-black">Click Image Upload</span>
                    </div>
                    <p className="mt-2 text-xs text-black">PNG, JPG, BMP, WebP</p>
                  </div>
                )}
                <input 
                  type="file" 
